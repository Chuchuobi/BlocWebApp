...
//  BlocBrowser
//
//  Created by Chuchu on 8/19/15.
//  Copyright (c) 2015 Chuchu Obiekwe. All rights reserved.
//
...
//    [self.webView loadRequest:request];
    ...
    // commented out the the back, foward, stop & reload buttons ^ because we addButtonTargets method at the bottom
...
//    [mainView addSubview:self.reloadButton];
    // use loop for ^ commented section
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if (whiteSpaceRange.location != NSNotFound) {
        ...
        URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.google.com/search?q=%@", secondString]];
...
- (void) updateButtonsAndTitle {
    ...
    //self.reloadButton.enabled = !self.webView.isLoading; // added the below statement
